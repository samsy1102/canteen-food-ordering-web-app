...
<head>
    ...
    <link href="../img/default.png" rel="icon">
    <link href="../css/login.css" rel="stylesheet">

    <title>Database Error | Yadav's Hut</title>
</head>
...
<body class="d-flex flex-column h-100">
    <header class="navbar navbar-expand-md navbar-light fixed-top bg-light shadow-sm mb-auto">
        <div class="container-fluid mx-4">
            <a href="../index.php">
                <img src="../img/LOGO_BLACK.png" width="125" class="me-2" alt=" Yadav's Hut Logo">
            </a>
    ...
    <div class="container form-signin text-center restricted mt-auto">
            ...
            <p class="mb-3 fw-normal text-bold text-wrap">Cannot connect to Yadav's Hut database right now.</p>
